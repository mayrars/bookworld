              ...
              <>
                ...
                <li>
                  <button
                    ...
                    className="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-red-600 md:p-0 dark:text-white dark:hover:text-red-500 dark:hover:bg-gray-700"
                  >
                    Cerrar sesión
                  </button>
                </li>
